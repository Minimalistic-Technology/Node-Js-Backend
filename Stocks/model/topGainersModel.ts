...
export interface TopGainerDocument extends Document {
...
const TopGainersSchema = new Schema<TopGainerDocument>({
  category: {
    type: String,
...
const TopGainers: Model<TopGainerDocument> = mongoose.model<TopGainerDocument>(
  'TopGainers',
  TopGainersSchema
);
