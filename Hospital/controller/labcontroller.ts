// controllers/figma/labController.ts
...
export const getAlphabets = async (_req: Request, res: Response) => {
 try {
...
export const getLabNamesByLetter = async (req: Request, res: Response) => {
  try {
...
export const getLabsByLetter = getLabNamesByLetter;

export const getLabDetailsById = async (req: Request, res: Response) => {
  try {
...
export const createLabForLetter = async (req: Request, res: Response) => {
  try {
    const letter = req.params.letter.toUpperCase();
    const { name, researchArea, researchers, contact, publications } = req.body;
...
export const bulkCreateLabsForLetter = async (req: Request, res: Response) => {
  try {
    const letter = req.params.letter.toUpperCase();
