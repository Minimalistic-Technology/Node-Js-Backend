...
userRouter.post("/enroll", auth_1.isAuthenticated, user_controller_1.enrollSpecificTag);
userRouter.post("/auth/forgot-password", user_controller_1.forgotPassword);
userRouter.post("/auth/reset-password/:token", user_controller_1.resetPassword);
userRouter.get("/get-users", auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("admin", "viewer"), user_controller_1.getAllUsers);
