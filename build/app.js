...
const productPriceRoutes_1 = __importDefault(require("./routes/productPriceRoutes"));
...
const workoutProgressRoutes_1 = __importDefault(require("./routes/workoutProgressRoutes"));
const otpRoutes_1 = __importDefault(require("./routes/otpRoutes"));
const propertyRoutes_1 = __importDefault(require("./routes/propertyRoutes"));
const bmi_routes_1 = __importDefault(require("./routes/bmi.routes"));
const reviewRoutes = require('./routes/hospital/review');
const login_1 = __importDefault(require("./routes/hospital/login"));
const productToolRoutes_1 = __importDefault(require("./routes/stocks/productToolRoutes"));
const doctorreview_1 = __importDefault(require("./routes/hospital/doctorreview"));
...
exports.app.use('/api', bmi_routes_1.default);
exports.app.use('/api/hospital', reviewRoutes);
exports.app.use('/api/login', login_1.default);
exports.app.use('/api/producttools', productToolRoutes_1.default);
exports.app.use('/api/doctorreview', doctorreview_1.default);
exports.app.use('/api', cart_routes_1.default);
exports.app.use('/api', feedback_routes_1.default);
// body parser
...
const mp = "";
const mn = "";
exports.app.use("/api/v1/auth", authRoutes);
// testing api
