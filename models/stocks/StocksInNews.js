...
const stocksInNewsSchema = new mongoose.Schema({
  name: {
    type: String,
    required: true,
  },
  ...
  details: {
    ...
    events: [{
      date: String, // e.g., "15 Jun 2025"
      title: String, // e.g., "Board Meeting"
      subtitle: String, // e.g., "To discuss quarterly results and future EV strategy"
      amount: String, // e.g., "₹2.50" (optional, for dividends)
      link: String, // e.g., "View Details" (optional)
    }],
    news: [{
...
module.exports = mongoose.model('StocksInNews', stocksInNewsSchema);