...
const FNOloosersSchema = new mongoose.Schema({
  name: { type: String, required: true },         // e.g., "Yes Bank"
  icon: { type: String, required: true },         // e.g., image URL
  price: { type: String, required: true },        // e.g., "20.02"
  change: { type: String, required: true },       // e.g., "+25.20(1.05%)"
...
module.exports = mongoose.model('FNOloosers', FNOloosersSchema);
